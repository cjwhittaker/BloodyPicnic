Public Class event_manager
    ...
    Private Sub event_time_inc_ValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles event_time_inc.ValueChanged
        ...
        duskmins = Hour(TimeValue(scenariodefaults.Dusk.Text)) * 60 + Minute(TimeValue(scenariodefaults.Dusk.Text))
        mins = (390 + 30 * event_time_inc.Value)
        If mins > duskmins Then event_time_inc.Value = event_time_inc.Value - 1 : Exit Sub
        event_time.Text = Format(TimeSerial(0, mins, 0), "HH:mm")
    End Sub
